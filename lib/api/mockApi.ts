      ...
      spans: [
        {
          ...
          llmCalls: [
              { llmCallId: "llm-1", vendor: "ANTHROPIC" as const, modelName: "CLAUDE_4_5_SONNET", inputTokens: 3200, outputTokens: 480, latencyMs: 1840, finishReason: "end_turn", status: "COMPLETED" as const }
          ],
          patches: [],
        ...
        },
        {
          ...
          llmCalls: [
              { llmCallId: "llm-2", vendor: "ANTHROPIC" as const, modelName: "CLAUDE_4_5_SONNET", inputTokens: 4800, outputTokens: 1640, latencyMs: 2100, finishReason: "end_turn", status: "COMPLETED" as const }
          ],
          patches: [
      ...
      spans: [
        {
          ...
          llmCalls: [
              { llmCallId: "llm-3", vendor: "ANTHROPIC" as const, modelName: "CLAUDE_4_5_SONNET", inputTokens: 3120, outputTokens: 620, latencyMs: 1600, finishReason: "end_turn", status: "COMPLETED" as const }
          ],
          patches: [],
